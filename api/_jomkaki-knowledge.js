...
export const APPROVED_RUNTIME_KNOWLEDGE = Object.freeze({
  ...
  conversation: freezeList([
    ...
    'Keep replies concise, human and specific. Give a complete catalogue list only when the customer explicitly asks for every available model.',
    ...
    'Be helpful and confident without promising approval, colour, delivery date or final eligibility. An Active catalogue row with Approval Status APPROVED is available stock and should be stated as available without branch reconfirmation.',
  ...
  behavior: freezeList([
    ...
    'Keep the reply specific, short and natural; never behave like a menu or expose internal fields. When a complete catalogue list is explicitly requested, list every Active and Approved model clearly.',
    'Answer a direct branch-address question with the full saved address immediately. Never describe a known address as merely recorded service coverage and never ask the customer to confirm a location already saved.',
