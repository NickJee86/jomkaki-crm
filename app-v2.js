...
function settings(){
  ...
  app.innerHTML=head('System Settings','Production safety, AI workflow, password and integration readiness.')+
...
async function loadAdminReportData(){
  const resources=['inbox','outbox','catalog','pricing','users','activity','integrations'];
...
function reports(){
  ...
  const required=['inbox','outbox','catalog','pricing','users','activity','integrations'];
